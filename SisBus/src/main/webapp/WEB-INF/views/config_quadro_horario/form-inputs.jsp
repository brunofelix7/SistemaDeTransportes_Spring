...
<div class="form-group">
	<label for="intervalo">Intervalo<span style="color: red;">*</span></label>
	<form:input path='intervalo' disabled="true" id="intervalo" type='text' class="form-control" placeholder="Exemplo: 14:00-16:00" required="required" />
