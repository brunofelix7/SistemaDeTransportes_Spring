...
<h4 style='color: #000000'>Dados Pessoais</h4>
...
<div class="form-group">
	<label for="usuario.login">Login<span style="color: red;">*</span></label>
...
<div class="form-group">
	<label for="usuario.email">E-mail<span style="color: red;">*</span></label>
...
<div class="form-group">
	<label for="usuario.senha">Senha<span style="color: red;">*</span></label>
...
<div class="form-group">
	<label for="role">Tipo de Permissão<span style="color: red;">*</span></label>
	<form:select required="required" path="role" class="form-control" style='width: 30%;'>
		<form:option value="" label="-- Selecione --"/>
    	<form:options items="${permissoes}" itemValue="value" itemLabel="item" />
	</form:select>
...
<div class="form-group">
	<label for="exameDeSaude">Exame De Saúde<span style="color: red;">*</span></label>
	<form:select required="required" path="exameDeSaude" class="form-control" style='width: 30%;' id="exameDeSaude" onChange="validarExame()">
		<form:option value="" label="-- Selecione --"/>
    	<form:options items="${value}" />
	</form:select>
	<form:errors path='exameDeSaude' />
...
<div class="form-group">
	<label for="funcao">Função<span style="color: red;">*</span></label>
	<form:select required="required" path="funcao" class="form-control" style='width: 30%;' id="funcao" onChange="validarFuncao()">
		<form:option value="" label="-- Selecione --"/>
    	<form:options items="${value}" />
   	</form:select>
	<form:errors path='funcao' />
...
<br/>
<h4 style='color: #000000'>Endereço</h4>
<div class="form-group">
	<label for="rua">Rua<span style="color: red;">*</span></label>
		<form:input path='endereco.rua' type='text' class="form-control" required="required" pattern="([A-Za-z]).{0,80}" title="Esse campo não pode conter números, caracteres especiais, nem ultrapassar mais de 80 caracteres"/>
		<form:errors path='endereco.rua' />
</div>
<div class="form-group">
	<label for="bairro">Bairro<span style="color: red;">*</span></label>
		<form:input path='endereco.bairro' type='text' class="form-control" required="required" pattern="([A-Za-z]).{0,15}" title="Esse campo não pode conter números, caracteres especiais, nem ultrapassar mais de 15 caracteres"/>
		<form:errors path='endereco.bairro' />
</div>
<div class="form-group">
	<label for="cidade">Cidade<span style="color: red;">*</span></label>
		<form:input path='endereco.cidade' type='text' class="form-control" required="required" pattern="([A-Za-z]).{0,25}" title="Esse campo não pode conter números, caracteres especiais, nem ultrapassar mais de 25 caracteres"/>
		<form:errors path='endereco.cidade' />
</div>
<div class="form-group">
	<label for="estado">Estado<span style="color: red;">*</span></label>
	<form:select required="required" path="endereco.estado" class="form-control" style='width: 20%;'>
		<form:option value="" label="--"/>
    	<form:options items="${value}" />
	</form:select>
	<form:errors path='endereco.estado' />
...
<div class="form-group">
	<label for="cep">CEP<span style="color: red;">*</span></label>
		<form:input path='endereco.cep' type='text' class="form-control" placeholder='58079530' required="required" maxlength="8" pattern="\d{8}" title="Esse campo não pode conter texto ou caracteres especiais, nem ultrapassar mais de 8 dígitos"/>
		<form:errors path='endereco.cep' />
</div>
 --%>