...
<template:admin>
            ...
            <nav class="nav-breadcrumb">
                <div class="nav-wrapper">
                    <div class="col s12">
                        ...
                        <a href="#!" class="breadcrumb">Atualizar operação</a>
                    </div>
                </div>
            </nav>
        </div>
 ...
 <div class="panel panel-primary" style='width: 100%; margin-left: auto ; margin-right: auto ; margin-top:0; margin-bottom:0;'>
	<div class="panel-heading">
      ...
      <form:form role="form" cssClass="well" commandName="operacao" servletRelativeAction="/gestor/operacao/${operacao.id}" method="POST" >
