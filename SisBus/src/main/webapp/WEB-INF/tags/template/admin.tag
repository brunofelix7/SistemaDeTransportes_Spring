...
<body>
	...
	<ul id="slide-out" class="side-nav fixed">
		...
		<ul class="collapsible sb-collapsible-menu" data-collapsible="accordion">
			...
			<li>
				<div class="collapsible-header">
					<i class="icon-share-2"></i>Operação
				</div>
				<div class="collapsible-body">
					<ul class="collapsible" data-collapsible="accordion">
						<li><a href="<c:url value='/gestor/operacao/form'/>"
							class="collapsible-header">Registro de Operação</a></li>
							<li><a href="<c:url value='/gestor/operacao'/>"
						class="collapsible-header">Gerenciar operações</a></li>
					</ul>
				</div>
			</li>
