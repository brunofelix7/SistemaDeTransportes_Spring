...
public class Chamado {
	...
	@Column(nullable = true , name = "data_chamado")
	...
	@Column(nullable = true, name = "hora_fechamento")
	@Temporal(TemporalType.TIME)
	private Date horaFechamento;
	
	@Column(nullable = true, name = "tempo_espera")
	@Temporal(TemporalType.TIME)
	private Date tempoEspera;
	
	@Column(nullable = true, name = "contador")
	@Temporal(TemporalType.TIME)
